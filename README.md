...
Доработать программу из [лабораторной работы №6](https://github.com/aerosolus/Lab6RS) следующим образом:
...
1. Для многопоточного чтения запросов использовать <r>`ForkJoinPool`</r>
